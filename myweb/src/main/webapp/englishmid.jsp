...
<div id = "sidenav" class="sidenav">
 ...
 <p class = "title">English Language Practice Tests</p>
    <table  class = "headers">
      <tr>
     ...
     <table id = "table" class = "separate">
      ...
      <tr class = "hoverColumn" onclick="window.location='english1mid.jsp'">
		...
		String subject = "englishmid";
		
			try{
				connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
				statement = connection.createStatement();
				String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 41 + "'" + " AND subject='" + subject + "'";
     ...
     <tr class = "hoverColumn" onclick="window.location='english2mid.jsp'">
      ...
      <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 42 + "'" + " AND subject='" + subject + "'";
      ...
      <tr class = "hoverColumn"  onclick="window.location='english3mid.jsp'">
  ...
  <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 43 + "'" + " AND subject='" + subject + "'";
		...
		%>
         ...
         <tr class = "hoverColumn" onclick="window.location='english4mid.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 44 + "'" + " AND subject='" + subject + "'";
      ...
      <tr class = "hoverColumn" onclick="window.location='english5mid.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 45 + "'" + " AND subject='" + subject + "'";
