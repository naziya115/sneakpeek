...
<!-- Tests -->
 ...
 <p class = "title">Mathematics Practice Tests</p>
    <table  class = "headers">
      <tr>
    ...
    <table class = "separate">
      ...
      <tr class = "hoverColumn" onclick="window.location='math1mid.jsp'">
		...
		String subject = "mathmid";
		
			try{
				connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
				statement = connection.createStatement();
				String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 46 + "'" + " AND subject='" + subject + "'";
     ...
     <tr class = "hoverColumn" onclick="window.location='math2mid.jsp'">
      ...
      <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 47 + "'" + " AND subject='" + subject + "'";
      ...
      <tr class = "hoverColumn"  onclick="window.location='math3mid.jsp'">
  ...
  <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 48 + "'" + " AND subject='" + subject + "'";
		...
		%>
         ...
         <tr class = "hoverColumn" onclick="window.location='math4mid.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 49 + "'" + " AND subject='" + subject + "'";
      ...
      <tr class = "hoverColumn" onclick="window.location='math5mid.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 50 + "'" + " AND subject='" + subject + "'";
