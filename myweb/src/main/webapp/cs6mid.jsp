...
<div id = "head" class="header boxShadow">
    ...
    <div class="main-editor">
        ...
        if(localStorage.getItem("lang") === "kaz"||localStorage.getItem("lang") === "rus"){
        	document.querySelector(".saveCode").style.width = "100px";
		...
		<p class = "task">Write html code using tag font and different attributes to change colors of any text into red<br>
			Note: font size must be Arial.
		</p>
    ...
    <script src="./csjsmid/cs6mid_script.js"></script>
