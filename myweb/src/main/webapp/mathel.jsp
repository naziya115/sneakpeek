...
<!-- Tests -->
 ...
 <p class = "title">Mathematics Practice Tests</p>
    ...
    <table class = "separate">
      ...
      <tr class = "hoverColumn" onclick="window.location='math1el.jsp'">
       ...
       <td class = "easy">Easy</td>
		...
		String subject = "mathel";
		
			try{
				connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
				statement = connection.createStatement();
				String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 61 + "'" + " AND subject='" + subject + "'";
      ...
      <tr class = "hoverColumn" onclick="window.location='math2el.jsp'">
      ...
      <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 62 + "'" + " AND subject='" + subject + "'";
        ...
        <tr class = "hoverColumn" onclick="window.location='math3el.jsp'">
  ...
  <%
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 63 + "'" + " AND subject='" + subject + "'";
		...
		%>
          ...
          <tr class = "hoverColumn" onclick="window.location='math4el.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 64 + "'" + " AND subject='" + subject + "'";
        ...
        <tr class = "hoverColumn" onclick="window.location='math5el.jsp'">
		...
		try{ 
			connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
			statement = connection.createStatement();
			String sql ="SELECT * FROM scores WHERE username='" + username + "' AND testorder='" + 65 + "'" + " AND subject='" + subject + "'";
