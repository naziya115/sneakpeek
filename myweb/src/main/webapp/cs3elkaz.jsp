...
<!-- Q1-Q5 -->
<!-- с b a c a-->
<div class="title">Информатика Тест 8</div>

<form action=ScoresServlet method = "post" name = "form" >
<div class="question">
  <p><strong>Q1</strong>: «Ақпарат» латынның .... деген ұғымдарды білдіреді.
  <label><input onclick="option001()" name="button001" type="radio"/> A. информатика</label>
  <label><input onclick="option002()" name="button001" type="radio" /> B. аналық тақша, жүйелік блок</label>
  <label><input onclick="option003()" name="button001" type="radio" /> C. түсіндіру, баяндау, мәлімет</label>
  <label><input onclick="option004()" name="button001" type="radio"/> D. мақсат, міндет</label>
</div> 
<div class=question>
  <p><strong>Q2</strong>:  Қазіргі кезде ақпарат түсінігін айқындаудың кең тараған қанша теориясы бар?</p>
  <label><input onclick="option005()" name="button002" type="radio" /> A. 5</label>
  <label><input onclick="option006()" name="button002" type="radio" /> B. 4</label>
  <label><input onclick="option007()" name="button002" type="radio" /> C. 3</label>
  <label><input onclick="option008()" name="button002" type="radio" /> D. 2</label>
</div>
<div class=question>
...
<!-- JAVA Script -->
<script src="./cseljs/cs3elkaz_script.js"></script>
